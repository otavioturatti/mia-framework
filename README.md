<p align="center">
  ...
  <p align="center">
    <a href="https://pypi.org/project/mia-framework/"><img src="https://img.shields.io/pypi/v/mia-framework?color=blue" alt="PyPI"></a>
    <a href="https://pypi.org/project/mia-framework/"><img src="https://img.shields.io/pypi/pyversions/mia-framework" alt="Python"></a>
    <a href="https://github.com/otavioturatti/mia-framework/blob/main/LICENSE"><img src="https://img.shields.io/github/license/otavioturatti/mia-framework" alt="License"></a>
  </p>
</p>
...
```bash
pip install mia-framework
```

This installs the `mia` package and two CLI commands: `mia-generate` and `mia-export`.
